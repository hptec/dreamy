...
- section_type=hero 为首页配置单例：全表最多一条（enabled=false 也仍占用单例位）；Hero 不存 banner_id 绑定
...
| STEP-03a | hero → StoreBannerService.list(HERO, locale) 取全部当前有效 Banner（sort ASC、id ASC），装配权威 `data.banners[]`；同时把 banners[0] 复制为 data.title/image_url/cta_* 扁平兼容字段。无结果或失败时省略 Hero 区块 + WARN，502801 | 502801 |
  ...
  "sections": [
    {
      ...
      "data": {
        "banners": [
          {"id": 7, "title": "...", "subtitle": "...", "cta_text": "...", "cta_link": "...", "cta_text_secondary": "...", "cta_link_secondary": "...", "image_url": "..."},
          {"id": 8, "title": "...", "subtitle": "...", "cta_text": "...", "cta_link": "...", "cta_text_secondary": "...", "cta_link_secondary": "...", "image_url": "..."}
        ],
        "title": "...", "subtitle": "...", "cta_text": "...", "cta_link": "...", "cta_text_secondary": "...", "cta_link_secondary": "...", "image_url": "..."
      }
    },
    {
...
| FLOW-009（Hero 跨域 Banner） | GET /api/store/content/home 内部 StoreBannerService.list(HERO, locale) | 非独立端点；返回全部有效 Banner 轮播数组 |
