...
export const blogPosts = [
  {
    ...
    cover: IMG('kissprom/wedding-beach-short-05.jpg'),
  ...
  },
  {
    ...
    category: 'Wedding Guest Guides', author: 'The Dreamy Atelier', status: 1,
    cover: IMG('davidsbridal/lifestyle-banner-bridal-02.jpg'),
  ...
  },
  {
    ...
    cover: IMG('kissprom/wedding-mermaid-lace-04.jpg'),
  ...
  },
  {
    ...
    category: 'Buying Guides', author: 'The Dreamy Atelier', status: 1,
    cover: IMG('davidsbridal/wedding-dress-02.jpg'),
  ...
  },
  {
    ...
    category: 'Buying Guides', author: 'The Dreamy Atelier', status: 1,
    cover: IMG('kissprom/wedding-aline-tulle-01.jpg'),
  ...
  },
  {
    ...
    cover: IMG('kissprom/wedding-aline-longsleeve-06.jpg'),
  ...
  },
  {
    ...
    category: 'Wedding Guest Guides', author: 'The Dreamy Atelier', status: 1,
    cover: IMG('birdygrey/bridesmaid-lemon-bella-10.jpg'),
  ...
  },
  {
    ...
    cover: IMG('davidsbridal/lifestyle-banner-occasion-03.jpg'),
...
export const lookbooks = [
  ...
  { title: 'The Garden Edit', theme: 'Garden & Boho', status: 1, description: 'Lace against greenery, lanterns under oaks, palettes grown from the landscape. Everything we love about saying vows in a garden.',
    cover: IMG('davidsbridal/lifestyle-banner-bridesmaid-01.jpg'),
...
export const banners = [
  { name: 'Hero — Coastal Season', imageUrl: IMG('davidsbridal/lifestyle-banner-bridal-02.jpg'), position: 'HERO', status: 1, sort: 1,
  ...
  { name: 'Hero — Garden Season', imageUrl: IMG('kissprom/wedding-aline-tulle-01.jpg'), position: 'HERO', status: 1, sort: 2,
    title: 'The Garden Edit', subtitle: 'Lace, tulle, and palettes grown from the landscape.', ctaText: 'Explore the Edit', ctaLink: '/lookbooks' },
  { name: 'Featured — Made-to-Order', imageUrl: IMG('kissprom/wedding-aline-lace-02.jpg'), position: 'FEATURED', status: 1, sort: 1,
  ...
  { name: 'Featured — Bridesmaid Program', imageUrl: IMG('birdygrey/bridesmaid-pink-bella-01.jpg'), position: 'FEATURED', status: 1, sort: 2,
    title: 'One Dress, Six Ways', subtitle: 'Convertible bridesmaid styles your friends will actually wear again.', ctaText: 'Shop Bridesmaids', ctaLink: '/bridesmaids' }
]
...
export const coupons = [
  ...
  { code: 'FREESHIP199', name: 'Free US Shipping over $199', type: 3, value: 'Free Shipping', minAmount: 0, totalLimit: 20000, status: 1, description: 'Complimentary U.S. shipping on every order, every day — automatically applied at checkout.' },
