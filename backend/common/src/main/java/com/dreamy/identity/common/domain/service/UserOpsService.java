...
public class UserOpsService {
    ...
    public PageData<com.dreamy.identity.common.dto.UserProfileDTO> pageUserDTOs(
        ...
        List<com.dreamy.identity.common.dto.UserProfileDTO> items =
    ...
    public UserDetailData userDetail(String userId, int historyLimit) {
        com.dreamy.identity.common.dto.UserProfileDTO user = dtoMapper.toProfile(getUser(userId));
        List<com.dreamy.identity.common.dto.IdentityDTO> identities =
                identities(userId).stream().map(dtoMapper::toIdentity).toList();
        List<com.dreamy.identity.common.dto.SessionDTO> sessions =
                activeSessions(userId).stream().map(dtoMapper::toSession).toList();
        List<com.dreamy.identity.common.dto.LoginHistoryDTO> history =
    ...
    public com.dreamy.identity.common.dto.UserProfileDTO toggleUserStatusDTO(String userId, String status) {
    ...
    public record UserDetailData(
            com.dreamy.identity.common.dto.UserProfileDTO user,
            List<com.dreamy.identity.common.dto.IdentityDTO> identities,
            List<com.dreamy.identity.common.dto.SessionDTO> sessions,
            List<com.dreamy.identity.common.dto.LoginHistoryDTO> loginHistory) {}
    ...
    public List<LoginHistoryEntity> recentLoginHistory(String userId, int limit) {
    ...
    public List<UserSessionEntity> activeSessions(String userId) {
        return sessionService.listActive(userId);
    }

    public List<com.dreamy.identity.common.repository.entity.UserIdentityEntity> identities(String userId) {
    ...
    @Transactional
    public UserEntity toggleUserStatus(String userId, String status) {
     ...
     */
    @Transactional
    public void forceLogout(String userId, String scope, String sessionId) {
