...
CREATE TABLE external_gateway_config (
  ...
  protocol                  TINYINT      NOT NULL DEFAULT 1 COMMENT '协议：openai-compatible(1)',
  base_url                  VARCHAR(255) NOT NULL COMMENT '网关地址',
  api_key_encrypted         VARCHAR(4096) NOT NULL COMMENT 'API Key密文(AES-256-GCM, v1:前缀+IV+密文 base64)',
