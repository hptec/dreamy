...
/**
 * store/admin 端查询参数解析/校验工具（V-MKT-001~006/016~018 共用；非法 → MarketingFieldErrors 收集 422704）。
 */
public final class MarketingParams {
    ...
    public static String parseLocale(String locale, MarketingFieldErrors errors) {
    ...
    public static int parsePage(Integer page, MarketingFieldErrors errors) {
        if (page == null) {
            return 1;
        }
        if (page < 1) {
    ...
    public static int parsePageSize(Integer pageSize, MarketingFieldErrors errors) {
        if (pageSize == null) {
            return 20;
        }
    ...
    public static String checkMaxLength(String value, int maxLength, String field, MarketingFieldErrors errors) {
