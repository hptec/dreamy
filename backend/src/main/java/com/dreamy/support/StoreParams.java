...
/**
 * store 端查询参数解析/校验工具（V-CAT-001~011/017~019 共用；非法 → CatalogFieldErrors 收集 422501）。
 */
public final class StoreParams {
    ...
    public static String parseLocale(String locale, CatalogFieldErrors errors) {
    ...
    public static int parsePage(Integer page, CatalogFieldErrors errors) {
        if (page == null) {
            return 1;
        }
        if (page < 1) {
    ...
    public static int parsePageSize(Integer pageSize, CatalogFieldErrors errors) {
        if (pageSize == null) {
            return 20;
        }
    ...
    public static void validatePriceRange(BigDecimal priceMin, BigDecimal priceMax, CatalogFieldErrors errors) {
    ...
    public static String parseSort(String sort, CatalogFieldErrors errors) {
    ...
    public static Long parsePositiveId(Long id, String field, CatalogFieldErrors errors) {
        if (id == null) {
            return null;
        }
        if (id <= 0) {
    ...
    public static String checkMaxLength(String value, int maxLength, String field, CatalogFieldErrors errors) {
