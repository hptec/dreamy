package com.dreamy.domain.review.entity;

import com.baomidou.mybatisplus.annotation.TableName;
import com.dreamy.enums.ReviewStatus;
import com.dreamy.domain.review.consts.ReviewDBConst;
...
public class Review extends LongAuditableEntity {
    ...
    @Column(name = ReviewDBConst.PRODUCT_ID,
            definition = "bigint NOT NULL COMMENT '逻辑外键 product.id（写前经 ReviewCatalogSnapshotPort 校验，CV-REV-005）'")
