...
public class UserOpsService {
    ...
    private final com.dreamy.dto.mapper.IdentityDtoMapper dtoMapper;

    public UserOpsService(UserMapper userMapper,
                          LoginHistoryMapper loginHistoryMapper,
                          SessionService sessionService,
                          IdentityService identityService,
                          com.dreamy.dto.mapper.IdentityDtoMapper dtoMapper) {
    ...
    public PageData<com.dreamy.dto.UserProfileDTO> pageUserDTOs(
        ...
        List<com.dreamy.dto.UserProfileDTO> items =
    ...
    public UserDetailData userDetail(Long userId, int historyLimit) {
        com.dreamy.dto.UserProfileDTO user = dtoMapper.toProfile(getUser(userId));
        List<com.dreamy.dto.IdentityDTO> identities =
                identities(userId).stream().map(dtoMapper::toIdentity).toList();
        List<com.dreamy.dto.SessionDTO> sessions =
                activeSessions(userId).stream().map(dtoMapper::toSession).toList();
        List<com.dreamy.dto.LoginHistoryDTO> history =
    ...
    public com.dreamy.dto.UserProfileDTO toggleUserStatusDTO(Long userId, UserStatus status) {
    ...
    public record UserDetailData(
            com.dreamy.dto.UserProfileDTO user,
            List<com.dreamy.dto.IdentityDTO> identities,
            List<com.dreamy.dto.SessionDTO> sessions,
            List<com.dreamy.dto.LoginHistoryDTO> loginHistory) {}
    ...
    public List<com.dreamy.domain.user.entity.UserIdentity> identities(Long userId) {
