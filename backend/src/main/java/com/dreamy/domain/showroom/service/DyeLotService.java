...
import com.dreamy.port.ShowroomDyeLotPort;
 ...
 * 同时承载 ShowroomDyeLotPort 实现（trading cart/quote 消费，showroom-data-detail §8.3）：
 ...
 */
@Service
public class DyeLotService implements ShowroomDyeLotPort {
    ...
    /**
     * ShowroomDyeLotPort.hintProductIds：customerId 无参与房/无命中 → 空数组
