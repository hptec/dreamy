 ...
 * owner（store 主体）首次互动时自动建 member——nickname = ShowroomIdentityQueryPort.getUserName(subject)
...
public class MemberResolver {
    ...
    private final ShowroomIdentityQueryPort identityPort;

    public MemberResolver(ShowroomMemberRepository memberRepository, ShowroomIdentityQueryPort identityPort) {
