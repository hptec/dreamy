package com.dreamy.domain.session.service;
...
import com.dreamy.infra.SessionValidityCache;
...
public class SessionService {
    ...
    public List<com.dreamy.dto.SessionDTO> listActiveViews(Long userId, String currentJti) {
        return listActive(userId).stream().map(s -> {
            com.dreamy.dto.SessionDTO dto = dtoMapper.toSession(s);
            boolean current = currentJti != null && currentJti.equals(s.getTokenId());
            return new com.dreamy.dto.SessionDTO(
