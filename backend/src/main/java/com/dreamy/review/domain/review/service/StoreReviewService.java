...
import com.dreamy.review.dto.ReviewDtos.ImageRef;
import com.dreamy.review.dto.ReviewDtos.ProductCardDto;
import com.dreamy.review.dto.ReviewDtos.ReviewImageDto;
import com.dreamy.review.dto.ReviewDtos.ReviewPageSnapshot;
...
import com.dreamy.review.support.PaginatedFactory;
import com.dreamy.review.support.RatingSummary;
...
public class StoreReviewService {
    ...
    public StoreReviewService(ReviewRepository reviewRepository, ReviewImageRepository imageRepository,
                              ...
                              TradingPurchaseQueryPort purchasePort, CatalogSnapshotPort catalogPort,
                              IdentityQueryPort identityPort, StorageProperties storageProperties) {
     ...
     * product 卡片简况批量装配（CatalogSnapshotPort，NP-REV-001 防 N+1，商品已删除容忍 null）；
    ...
    public Paginated<StoreMyReviewDto> listMyReviews(Long customerId, Integer page, Integer pageSize) {
        ...
        // product 卡片简况批量装配
        Map<Long, CatalogSnapshotPort.ProductBrief> briefs = catalogPort.getProductBriefs(
    ...
    private StoreMyReviewDto toMyDto(Review review, List<ReviewImageDto> images,
                                     CatalogSnapshotPort.ProductBrief brief) {
    ...
    private List<String> validateImages(List<ImageRef> images, FieldErrors errors) {
