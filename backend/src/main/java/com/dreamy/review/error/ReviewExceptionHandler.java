package com.dreamy.review.error;
...
import com.dreamy.review.i18n.ReviewMessageResolver;
import huihao.web.R;
...
/**
 * review 域异常处理器（仅作用于 com.dreamy.review 包内 Controller，优先于 identity GlobalExceptionHandler）。
 ...
 */
@RestControllerAdvice(basePackages = "com.dreamy.review")
