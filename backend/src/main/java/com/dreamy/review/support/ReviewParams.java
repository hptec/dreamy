 ...
 * 非法 → FieldErrors 收集 422801，与 catalog StoreParams 同口径）。
 */
public final class ReviewParams {
    ...
    public static Long parseRequiredProductId(Long productId, FieldErrors errors) {
        if (productId == null) {
    ...
    public static ReviewSort parseSort(String sort, FieldErrors errors) {
    ...
    public static String parseSearch(String search, FieldErrors errors) {
        if (search == null) {
            return null;
        }
