package com.dreamy.marketing.error;
...
/**
 * marketing 域异常处理器（仅作用于 com.dreamy.marketing 包内 Controller，优先于 identity GlobalExceptionHandler）。
 ...
 */
@RestControllerAdvice(basePackages = "com.dreamy.marketing")
