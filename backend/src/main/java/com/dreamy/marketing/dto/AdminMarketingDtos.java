package com.dreamy.marketing.dto;

import com.dreamy.marketing.dto.MarketingTranslationDtos.BannerTranslationDto;
...
import com.dreamy.marketing.dto.MarketingTranslationDtos.GuideTranslationDto;
import com.dreamy.marketing.dto.MarketingTranslationDtos.LookbookTranslationDto;
import com.dreamy.marketing.dto.MarketingTranslationDtos.RealWeddingTranslationDto;
...
public final class AdminMarketingDtos {
    ...
    public record CouponUpsert(String code, String name, String type, String value, BigDecimal minAmount,
                               Integer totalLimit, LocalDateTime startAt, LocalDateTime endAt, String status,
                               String description, List<CouponTranslationDto> translations) {
    }

    /** openapi Coupon（used_count 只读核销计数） */
    public record CouponDto(Long id, String code, String name, String type, String value, BigDecimal minAmount,
                            Integer totalLimit, Integer usedCount, LocalDateTime startAt, LocalDateTime endAt,
                            String status, String description, List<CouponTranslationDto> translations) {
    }
    ...
    public record FlashSaleUpsert(String name, String discount, LocalDateTime startAt, LocalDateTime endAt,
                                  String status, List<Long> productIds, List<FlashSaleTranslationDto> translations) {
    }
    ...
    public record BannerUpsert(String name, String imageUrl, String position, LocalDateTime startTime,
                               LocalDateTime endTime, String status, Integer sort, String title, String subtitle,
                               String ctaText, List<BannerTranslationDto> translations) {
    }

    /** openapi Banner（clicks 只读） */
    public record BannerDto(Long id, String name, String imageUrl, String position, LocalDateTime startTime,
                            LocalDateTime endTime, String status, Integer sort, Integer clicks, String title,
    ...
    public record BlogPostUpsert(String title, String cover, String category, String author, String content,
                                 String slug, String status, List<BlogPostTranslationDto> translations) {
    }
    ...
    public record BlogPostDto(Long id, String title, String cover, String category, String author, String content,
                              String slug, String status, LocalDateTime publishedAt, Integer views,
    ...
    public record RealWeddingUpsert(String couple, String location, String theme, String weddingDate, String cover,
                                    String status, String title, String story, List<Long> productIds,
    ...
    public record RealWeddingDto(Long id, String couple, String location, String theme, String weddingDate,
                                 String cover, String status, String title, String story, List<Long> productIds,
                                 List<RealWeddingTranslationDto> translations) {
    }

    /** openapi LookbookUpsert（V-MKT-067~071；description=DEC-MKT-1 增量字段） */
    public record LookbookUpsert(String title, String theme, String status, String description,
                                 List<Long> productIds, List<LookbookTranslationDto> translations) {
    }

    /** openapi Lookbook */
    public record LookbookDto(Long id, String title, String theme, String status, String description,
                              List<Long> productIds, List<LookbookTranslationDto> translations) {
    }

    /** openapi GuideUpsert（V-MKT-075~080；body=DEC-MKT-1 增量字段） */
    public record GuideUpsert(String phase, String timeframe, String title, Integer tasksCount, String status,
                              String body, List<GuideTranslationDto> translations) {
    }

    /** openapi Guide */
    public record GuideDto(Long id, String phase, String timeframe, String title, Integer tasksCount, String status,
                           String body, List<GuideTranslationDto> translations) {
    }
}
