...
import com.dreamy.controller.AnalyticsController;
...
/**
 * analytics 域异常处理器（仅作用于 analytics 域 Controller（assignableTypes 枚举，包合并后替代 basePackages 隔离），优先于 identity GlobalExceptionHandler）。
