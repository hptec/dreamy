...
import com.dreamy.trading.domain.refund.service.RefundEligibility;
import com.dreamy.trading.dto.TradingDtos.OrderLineDto;
import com.dreamy.trading.dto.TradingDtos.PaymentCredential;
import com.dreamy.trading.dto.TradingDtos.PaymentSummaryDto;
import com.dreamy.trading.dto.TradingDtos.StoreOrderDetail;
import com.dreamy.trading.dto.TradingDtos.StoreOrderListItem;
...
public class StoreOrderService {
    ...
    public Paginated<StoreOrderListItem> listOrders(Long customerId, Integer page, Integer pageSize, String status) {
        ...
        return PaginatedSupport.of(result, order -> toListItem(order, aggregates.get(order.getId())));
    }
    ...
    public PaymentCredential retryPayment(Long customerId, Long orderId) {
        ...
        StripePaymentIntent rebuilt = stripeClient.createPaymentIntent(
                com.dreamy.trading.support.Money.toMinor(order.getTotalAmount()),
        ...
        if (payment == null) {
            ...
            payment.setStatus(com.dreamy.trading.domain.enums.PaymentStatus.CREATED);
