...
import com.dreamy.showroom.domain.showroom.service.DyeLotService;
import org.springframework.stereotype.Component;

import java.util.List;

/**
 * trading 域 DyeLotPort 实现 bean（task-allocation SHR-IMPL-PORT：接口声明归 trading port 包
 ...
 */
@Component
public class TradingDyeLotPortAdapter implements com.dreamy.trading.port.DyeLotPort {
