...
import com.dreamy.showroom.i18n.ShowroomMessageResolver;
import huihao.web.R;
...
/**
 * showroom 域异常处理器（仅作用于 com.dreamy.showroom 包内 Controller，优先于 identity GlobalExceptionHandler）。
 ...
 */
@RestControllerAdvice(basePackages = "com.dreamy.showroom")
