 ...
 * 全部静态无状态，错误经 FieldErrors 收集映射 422101 fields 结构。
...
public final class ShowroomValidation {
    ...
    public static String validateName(String name, FieldErrors errors) {
    ...
    public static LocalDate validateWeddingDate(String weddingDate, FieldErrors errors) {
    ...
    public static String validateLocale(String locale, FieldErrors errors) {
    ...
    public static String validateInviteToken(String token, FieldErrors errors) {
    ...
    public static String validateNickname(String nickname, FieldErrors errors) {
    ...
    public static Long validateRequiredId(Long id, String field, FieldErrors errors) {
        if (id == null) {
     ...
     */
    public static String normalizeColor(String color, FieldErrors errors) {
        if (color == null) {
            return "";
        }
    ...
    public static VoteValue validateVote(String vote, FieldErrors errors) {
    ...
    public static String validateContent(String content, FieldErrors errors) {
    ...
    public static String validateEmail(String email, FieldErrors errors) {
        if (email == null) {
            return null;
        }
