...
import com.dreamy.marketing.domain.coupon.service.CouponDomainService.CouponQuote;
...
import com.dreamy.trading.dto.TradingDtos.OrderCreateRequest;
import com.dreamy.trading.dto.TradingDtos.OrderCreateResponse;
...
class OrderCreateServiceTest {
    ...
    void setUp() {
        service = new OrderCreateService(orderRepository, orderLineRepository, paymentRepository,
                ...
                couponDomainService, stripeClient, new ImmediateTxRunner(), storeOrderService);
    ...
    private CheckoutQuoteService.Computation computation(CouponQuote couponQuote) {
        ...
        ProductBrief product = new ProductBrief(PRODUCT, "aurelia-gown", "Aurelia Gown", null,
                new BigDecimal("100.00"), null, null, "https://img/a.jpg", 30, false, true, "published");
