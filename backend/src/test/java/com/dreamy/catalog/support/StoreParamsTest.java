...
class StoreParamsTest {
    ...
    void priceRange() {
        ...
        FieldErrors negative = new FieldErrors();
    ...
    @Test
    @DisplayName("422501 包络：FieldErrors.throwIfAny → details.fields 字典（error-strategy L2 要求 1）")
    void throwShape() {
        FieldErrors errors = new FieldErrors().reject("q", "required");
