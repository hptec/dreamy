...
class OrderLineRepositoryTest {
    ...
    /** 初始化 MyBatis-Plus lambda 缓存（LambdaQueryWrapper 需要 OrderLine/Order TableInfo，不依赖其他测试类的初始化顺序）。 */
    ...
    static void initMybatisPlusCache() {
        ...
        com.baomidou.mybatisplus.core.metadata.TableInfoHelper.initTableInfo(assistant, OrderLine.class);
