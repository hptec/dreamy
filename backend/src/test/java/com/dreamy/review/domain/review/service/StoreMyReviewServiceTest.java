...
class StoreMyReviewServiceTest {
    ...
    @BeforeEach
    void setUp() {
        service = new StoreReviewService(reviewRepository, imageRepository, cache, new ImmediateTxRunner(),
    ...
    @Test
    @DisplayName("入参校验：page/page_size 越界 → 422801（FieldErrors 口径），不触达仓储")
